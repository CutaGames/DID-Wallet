...
/**
 * created by tc_collin on 2020/4/13 10:08
 * Description: https://www.jianshu.com/p/0d01b5865760
 * version: 1.0
 */
...
//                            callBack.onSuccess(call, response, object);
    ...
    private Request buildRequest(String url, Map<String, String> params, HttpMethodType methodType) {
        ...
        builder.addHeader("X-CMC_PRO_API_KEY", "71ee6f23-6e76-4084-8de3-31c8c449e075");
        if (methodType == HttpMethodType.GET) {
            ...
            if (params != null) {
                for (Map.Entry<String, String> entry : params.entrySet()) {
                    ...
                    urlBuilder.addQueryParameter(mapKey, mapValue);
                }
