package com.tancheng.carbonchain.activities.storage.pubspace;
...
public class ActivityPubSpace extends AppCompatActivity {

    private static final Boolean DEBUG = true;
    private static final String TAG = "ActivityPubSpace";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pub_space);
        findViews();
        initViews();
    ...
    private void initViews(){
        ...
        SelectableItem selectableItemFolder = new SelectableItem(ActivityPubSpace.this);
        ...
        SelectableItem selectableItemPicture = new SelectableItem(ActivityPubSpace.this);
        ...
        SelectableItem selectableItemPpt = new SelectableItem(ActivityPubSpace.this);
    ...
    private void initBottomOperationUtil(){
        mPublicBottomOperationsUtil = new PublicBottomOperationsUtil(ActivityPubSpace.this, mViewGroup);
    ...
    private void jumpToShowDocument(){
        ...
        intent.setClass(ActivityPubSpace.this, ActivityShowDocument.class);
