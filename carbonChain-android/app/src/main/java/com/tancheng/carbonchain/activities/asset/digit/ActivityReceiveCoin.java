...
public class ActivityReceiveCoin extends AppCompatActivity {

    private LinearLayout mAddrLayout;
    private View mAddrBottomView;
    private TextView mTvCopySuccess;
    ...
    private void findViews(){
        ...
        mTvCopySuccess = findViewById(R.id.tv_copy_success);
    ...
    private void setOnClickListeners(){
        ...
        View.OnClickListener coinOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTvCopySuccess.setVisibility(View.VISIBLE);
        ...
        mIvTouchUpArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTvCopySuccess.setVisibility(View.GONE);
