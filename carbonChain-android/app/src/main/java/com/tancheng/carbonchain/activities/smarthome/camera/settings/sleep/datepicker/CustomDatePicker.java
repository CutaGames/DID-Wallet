package com.tancheng.carbonchain.activities.smarthome.camera.settings.sleep.datepicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvYearUnit, mTvMonthUnit, mTvDayUnit, mTvHourUnit, mTvMinuteUnit, mTvTitle;
    ...
    private void initView() {
        mPickerDialog = new Dialog(mContext, R.style.full_screen_dialog);
    ...
    private void initData() {
        ...
        mEndHour = MAX_HOUR_UNIT;// mEndTime.get(Calendar.HOUR_OF_DAY);//当前小时替换成最大小时
        mEndMinute = MAX_MINUTE_UNIT;// mEndTime.get(Calendar.MINUTE);//当前分钟替换成最大分钟
     ...
     * 是否显示年
     */
    public void setCanShowYear(boolean canShowYear){
        if(!canShowYear) {
