 ...
 */
public class FragmentAssetDataOriginal extends Fragment {
    private static final Boolean DEBUG = true;
    private static final String TAG = "FragmentAssetDataHealth";

    private ViewGroup mContainer;

    public FragmentAssetDataOriginal() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_asset_data_original, container,false);
        findViews(view);
        initViews();
        setOnClickListeners();
        return view;
