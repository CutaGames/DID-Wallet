...
import com.tancheng.carbonchain.activities.storage.video.ActivityVideoAlbumDetail;

/**
 * Created by gll on 2020/2/13.
 */

public class FragmentDocumentAlbum extends Fragment {
    private static final Boolean DEBUG = true;
    private static final String TAG = "FragmentDocumentAlbum";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_document_album, container,false);
        findViews(view);
        setOnClickListeners();
        return view;
    }
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (DEBUG) Log.d(TAG, "click document album folder");
            Intent intent = new Intent();
            intent.setClass(getActivity(), ActivityDocumentAlbumDetail.class);
