package com.tancheng.carbonchain.activities.storage.mycollect;
...
public class ActivityMyCollect extends AppCompatActivity {

    private static final Boolean DEBUG = true;
    private static final String TAG = "ActivityMyCollect";
    ...
    private void initViews(){
        ...
        SelectableItem selectableItemFolder = new SelectableItem(ActivityMyCollect.this);
        ...
        SelectableItem selectableItemPicture = new SelectableItem(ActivityMyCollect.this);
        ...
        SelectableItem selectableItemPpt = new SelectableItem(ActivityMyCollect.this);
    ...
    private void initBottomOperationUtil(){
        mPublicBottomOperationsUtil = new PublicBottomOperationsUtil(ActivityMyCollect.this, mViewGroup);
    ...
    private void jumpToShowDocument(){
        ...
        intent.setClass(ActivityMyCollect.this, ActivityShowDocument.class);
