...
public class FragmentVideoAlbum extends Fragment {
    private static final Boolean DEBUG = true;
    private static final String TAG = "FragmentVideoAlbum";
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (DEBUG) Log.d(TAG, "click video album folder");
            Intent intent = new Intent();
            intent.setClass(getActivity(), ActivityVideoAlbumDetail.class);
