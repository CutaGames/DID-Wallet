...
/**
 * Created by gll,自动换行布局(有问题，暂时不用)
 */
public class AutoLinefeedLayout2 extends ViewGroup {

    private int mScreenWidth;
    private int horizontalSpace, verticalSpace;
    private float mDensity;//设备密度，用于将dp转为px

    public AutoLinefeedLayout2(Context context) {
        this(context, null);
    }

    public AutoLinefeedLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        //获取屏幕宽高、设备密度
