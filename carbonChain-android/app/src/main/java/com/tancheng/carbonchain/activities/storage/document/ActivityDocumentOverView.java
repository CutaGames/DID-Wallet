...
import com.tancheng.carbonchain.utils.dropdowntablayout.document.DocumentTabLayout;

import java.util.ArrayList;
import java.util.List;

public class ActivityDocumentOverView extends AppCompatActivity implements DocumentTabLayout.OnTabSelectedListener {

    private DocumentTabLayout mTabLayout;
    private List<List<String>> mTitleList;
    private NoScrollViewPager mViewPager;
    private ViewGroup mViewGroup;

    private FragmentDocumentType mFragmentDocumentType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_document_over_view);
    ...
    private void findViews(){
        ...
        mTabLayout = (DocumentTabLayout) findViewById(R.id.tab_layout);
    ...
    private void inits(){
        ...
        mFragmentDocumentType = new FragmentDocumentType(mViewGroup);
        fragmentList.add(mFragmentDocumentType);
        fragmentList.add(new FragmentDocumentAlbum());

        MyViewPagerAdapter documentFragmentAdapter = new MyViewPagerAdapter(getSupportFragmentManager(),fragmentList);
        mViewPager.setAdapter(documentFragmentAdapter);
    ...
    private void showSortPopWindow(View v) {
        ...
        itemList.add(getString(R.string.document_sort_text_name));
        itemList.add(getString(R.string.document_sort_text_time));
    ...
    private TabLayout.OnTabSelectedListener mOnTabSelectedListener = new TabLayout.OnTabSelectedListener() {
        ...
        public void onTabSelected(TabLayout.Tab tab) {
            ...
            mFragmentDocumentType.removeBottomOperationsIfExits();
            mFragmentDocumentType.cancelLongClickMode();
        }
    ...
    public void selected(int tabPosition, int listPosition) {
        ...
        if(tabPosition == 0){
            mFragmentDocumentType.selectTime(listPosition);
        }
    }
    ...
    private List<List<String>> getTitleList(){
        ...
        subList.add(getString(R.string.drop_down_tab_layout_document_item_text_all));
        subList.add(getString(R.string.drop_down_tab_layout_document_item_text_doc));
        subList.add(getString(R.string.drop_down_tab_layout_document_item_text_xlsx));
        subList.add(getString(R.string.drop_down_tab_layout_document_item_text_ppt));
        subList.add(getString(R.string.drop_down_tab_layout_document_item_text_pdf));
        subList.add(getString(R.string.drop_down_tab_layout_document_item_text_txt));
        tabList.add(subList);
    ...
    public void onBackPressed() {
        if(mFragmentDocumentType.doBackPressed()){
