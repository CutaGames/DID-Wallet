...
public class FragmentMp3Album extends Fragment {
    private static final Boolean DEBUG = true;
    private static final String TAG = "FragmentMp3Album";
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (DEBUG) Log.d(TAG, "click mp3 album folder");
            Intent intent = new Intent();
            intent.setClass(getActivity(), ActivityMp3AlbumDetail.class);
